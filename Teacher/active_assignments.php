            ...
            <li class="dropdown user user-menu">
              ...
              <li class="user-header">
                  ...
                  <div class="pull-right">
                    <a href="active_assignments.php?logout='1'" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
  ...
  <div class="content-wrapper" style="background-color:#dee8f7 !important">
    ...
    <section class="content">
      ...
      <div class="col-md-12">
        ...
        <p style="margin-top:10px" class="btn btn-linkedin btn-block btn-lg">Active Assignments</p>


         <iframe src="teacher_filer/assignment_delete.php" style="height:800px;width: 1135px; margin-left: 5px;
