            ...
            <li class="dropdown user user-menu">
              ...
              <li class="user-header">
                  ...
                  <div class="pull-right">
                    <a href="create_class.php?logout='1'" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <section class="content">
      ...
      <div class="col-md-12">
          ...
          <div class="box box-warnin">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="post" action="Create_class.php">
              <?php include('errors.php'); ?>
                ...
                <div class="form-group">
                  ...
                  <br><br>
                   <button type="submit" class="btn btn-linkedin btn-block btn-lg" name="create_class">Create</button>
                </div>
        ...
        <iframe src="teacher_filer/delete.php" style="height:800px;width: 1135px; margin-left: 5px;
               background: transparent;" allowTransparency="true" scrolling="no" 
              frameborder="0">
              </iframe>
