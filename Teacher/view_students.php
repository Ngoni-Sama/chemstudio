...
<div class="wrapper">
 ...
 <p style="margin-top:10px" class="btn btn-linkedin btn-block btn-lg">Enrolled Students</p>

      <div class="col-md-6">
         
      
            <iframe src="teacher_filer/student_delete.php" style="height:800px;width: 1135px; margin-left: 5px;
