                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="user-footer">
                      ...
                      <div class="pull-right">
                        <a href="hardness_exp.php?logout='1'" class="btn btn-default btn-flat">Sign out</a>
                      </div>
                    </li>
                  </ul>
                </li>
      ...
      <div class="content-wrapper" style="background-color:#8eb3f0 !important">
        <div class="container">
          ...
          <section class="content">
            <iframe src="inorganic-chemistry-virtual-lab-master/src/lab/Water_analysis/experiment.html" style="height:850px;width: 1135px; margin-left: 1px;
