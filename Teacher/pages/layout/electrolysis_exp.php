      ...
      <header class="main-header">
          <nav class="navbar navbar-static-top" style="background: linear-gradient(-45deg, #a8c7f4 1%,#003c93 100%);">
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
              ...
              <li class="dropdown">
              <a href="electrolysis_exp.html" >Begin Simulation</a>
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="user-footer">
                      ...
                      <div class="pull-right">
                        <a href="electrolysis_exp.php?logout='1'" class="btn btn-default btn-flat">Sign out</a>
                      </div>
                    </li>
      ...
      <div class="content-wrapper" style="background-color:#8eb3f0 !important">
        <div class="container">
          ...
          <section class="content">
            <iframe src="electrolysis/src/lab/electrogravimetric_estimation_of_metals/experiment.html" style="height:800px;width: 1135px; margin-left: 1px;
