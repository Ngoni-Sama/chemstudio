    ...
    return {
        ...
        link: function(scope, element, attrs, dialogs) {
            ...
            function translationLabels() {
                ...
                scope.normality_label = _("Molarity of titrate");
                ...
                scope.drop_speed = _("Rate of flow of titrant");
                /** Unit for titrant */
                scope.solution_unit = _("ml");
                /**Unit for droplets */
                scope.solution_drops =_("(ml/sec)");
...
function initialisationOfVariables(scope) {
    ...
    stir_counter = 0;
    turner_count = 0;
    /** Variable used to show the volume of solution within the flask and burette */
    solution_vol = 0;
