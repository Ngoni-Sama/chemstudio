...
# Usage: Installing dependencies for inorganic-chemistry-virtual-lab
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /inorganic-chemistry-virtual-lab

COPY src/ /inorganic-chemistry-virtual-lab/src

WORKDIR ./inorganic-chemistry-virtual-lab/src
