...
<h3><center> Current Assignments </center> </h3>
 ...
 <table class="table table-bordered" style="background-color:#white">
  <thead>
   <tr>
    <th><font face="comic sans ms">Student Name</font></th>
    <th><font face="comic sans ms">Assignment Name</font></th>
	<th><font face="comic sans ms">Uploaded Files </font></th>
  </tr>
   </thead>
    <tbody>
                        <?php
	...
	$q="select count(*) \"total\"  from submissions";
	...
	$k=($page_cur-1)*$dis;
	$q="SELECT * FROM submissions WHERE teacher_name='$username' ORDER BY id ASC limit $k,$dis";
	$ros=mysql_query($q,$link);
