...
$conn = new mysqli("localhost", "root", "", "chem_teacher");
 
$sql = "SELECT * FROM `submissions` WHERE teacher_name='$username'";
$sql1 = "SELECT * FROM `assignments` WHERE teacher_name='$username'";
$sql2 = "SELECT * FROM `enrolled_students` WHERE teacher_name='$username'";
$sql3 = "SELECT marks FROM `student_grades`";
 
$connStatus = $conn->query($sql);
$connStatus1 = $conn->query($sql1);
$connStatus2 = $conn->query($sql2);
$connStatus3 = $conn->query($sql3);
 
$numberOfRows = mysqli_num_rows($connStatus);
$numberOfRows1 = mysqli_num_rows($connStatus1);
    ...
    <section class="content">
      ...
      <div class="row" >
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="submitted_assignments.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style="margin-left:300px;">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $numberOfRows1; ?><sup style="font-size: 20px">%</sup></h3>
            ...
            <a href="#" class="small-box-footer"><i class="fa fa-arrow-circle-righ"></i></a>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="active_assignments.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style="margin-left:300px;">
