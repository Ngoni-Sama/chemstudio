    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            queue.loadManifest([{ /** Loading all images into queue */
				...
				id: "ammeter",
                src: "././images/ammeter.svg",
                type: createjs.LoadQueue.IMAGE
			}, {
				id: "switch_base",
                src: "././images/switch_base.svg",
                type: createjs.LoadQueue.IMAGE
			}, {
				id: "rheostat_stand",
                src: "././images/rheostat_stand.svg",
                type: createjs.LoadQueue.IMAGE
			}, {
				id: "alkaline_cell",
                src: "././images/alkaline_cell.svg",
                type: createjs.LoadQueue.IMAGE
			}, {
				id: "rheostat",
            ...
            function handleComplete() { 
				...
				loadImages(queue.getResult("voltmeter"), "voltmeter", 1, 1, "", 0, 1, 1);
				loadImages(queue.getResult("ammeter"), "ammeter", 1, 1, "", 0, 1, 1);
				loadImages(queue.getResult("alkaline_cell"), "alkaline_cell", 1, 1, "", 0, 1, 1);
				loadImages(queue.getResult("switch_base"), "switch_base", 1, 1, "", 0, 1, 1);
				loadImages(queue.getResult("rheostat_stand"), "rheostat_stand", 10, 3, "", 0, 1, 1);
			...
			function translationLabels() {
				...
				scope.reset = _("Reset");
				scope.variables = _("Choose Variants");
