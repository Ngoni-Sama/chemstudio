...
<link rel="shortcut icon" type="image/png" href="../../image/fav-icon.png">
  ...
  <title>Chem Studio | Ionic and Convalent Radius </title>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          ...
          <li class="user-header">
              ...
              <div class="pull-right">
                <a href="elementRadius_exp.php?logout='1'" class="btn btn-default btn-flat">Sign out</a>
              </div>
            </li>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Ionic and Covalent Radius <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="ChemBonding_exp.html">Ionic and Covalent bonding</a></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <div class="content-wrapper" style="background-color:#f5f5f5 !important">
        <div class="container">
          ...
          <section class="content">
            <iframe src="ChemicalBonding/elementRadius.html" style="height:1200px;width: 1135px; margin-left: 1px;
