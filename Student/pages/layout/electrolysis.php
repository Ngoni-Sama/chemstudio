      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              ...
              <span style="color:#9ac1ff !important;">Electrolysis</span>
              <span class="pull-right-container">
              </span>
            </a>
            <ul class="treeview-menu" style="background-color:transparent;">
              ...
              <li><a href="./electrolysis.html" style="color:#cedffa;"><i class="fa fa-circle-o"></i> Electrolysis</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="background-color:transparent;">
              <li><a href="/Student/pages/UI/general.html" style="color:#cedffa;"><i class="fa fa-circle-o"></i> General Results</a></li>
              <li><a href="/Student/pages/UI/timeline.html" style="color:#cedffa;"><i class="fa fa-circle-o"></i> Teacher's Comments</a></li>
            </ul>
          </li>
      ...
      <div class="content-wrapper" style="background-color:#dee8f7 !important">
        <div class="container">
          ...
          <section class="content">
            <!-- <div style="margin-left:28px; border-radius: 10px; width:400px; length:400px; background-color: #f8f8fa; padding-left: 20px; padding-top: 0.2px; margin-top: 20px;">
              <h2 style="font-family:'Comfortaa', 'Roboto' !important; font-size: 22px;">KCSE Questions</h2>
              <a href="KCSE 2011.html" style="font-family:'Comfortaa', 'Roboto' !important; font-size: 16px;">KCSE 2011</a>
            </div>
            
            <div style="margin-left:28px; border-radius: 10px; width:400px; length:400px; background-color: #ffffff; padding-left: 20px; padding-top: 1px; margin-top: 20px;">
              <h2 style="font-family:'Comfortaa', 'Roboto' !important; font-size: 22px;">School Past Papers</h2>
              <a href="#" style="font-family:'Comfortaa', 'Roboto' !important; font-size: 16px;">End-Term 2018</a>
            </div>
            
            <div style="margin-left:28px; border-radius: 10px; width:400px; length:400px; background-color: #ffffff; padding-left: 20px; float:right; margin-left: 200px; margin-top:-180px;">
              <h2 style="font-family:'Comfortaa', 'Roboto' !important; font-size: 22px;">Assignments</h2>
              <a href="Assignment 1.html" style="font-family:'Comfortaa', 'Roboto' !important; font-size: 16px;">Assignment 1</a>
            </div>

            <div style="margin-left:28px; border-radius: 10px; width:400px; length:400px; background-color: #ffffff; padding-left: 20px; padding-top: 1px;  margin-left: 710px; margin-top: -84px;">
                <h2 style="font-family:'Comfortaa', 'Roboto' !important; font-size: 22px;">Revision Exercises</h2>
                <a href="titration_exp.html" style="font-family:'Comfortaa', 'Roboto' !important; font-size: 16px;">Titration Recap Exercise</a>
            </div> -->
