...
<link rel="shortcut icon" type="image/png" href="image/fav-icon.png">
  ...
  <link href="https://fonts.googleapis.com/css?family=Comfortaa" rel="stylesheet"> 
    ...
    <!-- Add IntroJs styles -->
    <link href="assets/introjs.css" rel="stylesheet">

    <link href="assets/css/bootstrap-responsive.min.css" rel="stylesheet">
    <script type="text/javascript" src="assets/intro.js"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" style="background: linear-gradient(-45deg, #a8c7f4 1%,#003c93 100%); margin-top:-20px;">
      ...
      <a data-step="2" data-intro="Hides or displays the navigation bar" href="#" class="sidebar-toggle blue" data-toggle="push-menu" role="button">
        <span class="sr-only">Toggle navigation</span>
      </a>

      <a href="index.php" data-step="1" data-intro="Clicking on this takes you to the index page" class="navbar-brand"><b>Chem</b>Studio</a>
      ...
      <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <!-- Menu Toggle Button -->
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-step="7" data-intro="Logout from here">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <style>
         ...
         <li class="treeview margin-top">
          <a href="#" data-step="3" data-intro="Select the type of Practical you wish to perform">
       ...
       <li class="treeview margin-top">
          <a href="#" data-step="4" data-intro="View and manage assignments given by your teacher">
            <i class="fa fa-hand-pointer-o" style="color: #cedffa;"></i>
        ...
        <li class="treeview">
          <a href="#" data-step="5" data-intro="See the results of marked submissions">
        ...
        <li class="treeview">
          <a href="#" data-step="6" data-intro="Take a look in a periodic table">
  ...
  <div class="content-wrapper" style="background-color:#dee8f7 !important">
    ...
    <section class="content"> 
      ...
      <a class="btn btn-large btn-primary" style="margin-top:-900px; margin-left: 40px;" href="javascript:void(0);" onclick="javascript:introJs().start();">Show me around</a>
      ...
      <script type='text/javascript' data-cfasync='false'>window.purechatApi = { l: [], t: [], on: function () 
        ...
        document.getElementsByTagName('HEAD').item(0).appendChild(script); script.onreadystatechange = script.onload = function (e) {
           if (!done && (!this.readyState || this.readyState == 'loaded' || this.readyState == 'complete')) { var w = new PCWidget({c: 
           '5c304897-d4fa-46f8-849f-ebd04d8d4515', f: true }); done = true; } }; })();</script>


<iframe src="todo_list/index.html" style="height:520px;width: 630px; margin-left: 1px; margin-top: 1px; margin-left:160px;" data-step="8" data-intro="Manage your tasks Efficiently"
