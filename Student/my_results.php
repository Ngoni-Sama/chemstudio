            ...
            <li class="dropdown user user-menu">
              ...
              <li class="user-header">
                  ...
                  <div class="pull-right">
                    <a href="my_results.php?logout='1'" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
  ...
  <div class="content-wrapper" style="background-color:#dee8f7 !important">
    ...
    <section class="content">
      ...
      <div class="col-md-12">
        ...
        <p style="margin-top:3px" class="btn btn-linkedin btn-block btn-lg">My Grades</p>
        ...
        <table id="example2" class="table table-bordered table-hover">
                ...
                $username=$_SESSION['username'];
                    ...
                    $conn = mysqli_connect("localhost", "root", "", "chem_teacher");
                      ...
                      $sql = "SELECT assignment, marks, remarks FROM student_grades where name='$username'";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                      // output data of each row
                      while($row = $result->fetch_assoc()) {
                        echo "<tr><td>" . $row["assignment"] . "</td><td>" . $row["marks"] . "</td><td>"
                    . $row["remarks"] ."</td></tr>";
                    }
                    echo "</table>";
                    } else { echo "You have no marked assignments"; }
                    $conn->close();
                ?>
                </thead>
                <tbody>
