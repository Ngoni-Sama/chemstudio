...
<div class="wrapper">
            ...
            <li class="dropdown user user-menu">
              ...
              <li class="user-header">
                  ...
                  <div class="pull-right">
                    <a href="my_assignments.php?logout='1'" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
  ...
  <div class="content-wrapper" style="background-color:#dee8f7 !important">
    ...
    <section class="content">
        ...
        <p style="margin-top:10px" class="btn btn-linkedin btn-block btn-lg">My Assignments</p>

         <iframe src="student_filer/display.php" style="height:800px;width: 1135px; margin-left: 1px;
